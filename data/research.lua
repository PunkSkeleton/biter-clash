data:extend({
	  ...
	  },
	  {
	    ...
	    prerequisites = {"small-biter", "logistic-science-pack"},
	    unit = {
	      count = 100,
	      ingredients = {
	        { "automation-science-pack", 1 },
	  ...
	  },
	  {
	    ...
	    prerequisites = {"medium-biter", "military-science-pack", "advanced-electronics", "engine"},
	    unit = {
	      count = 100,
	      ingredients = {
	        { "automation-science-pack", 1 },
	  ...
	  },
	  {
	    ...
	    prerequisites = {"big-biter", "military-science-pack", "chemical-science-pack", "advanced-electronics-2", "robotics"},
	    unit = {
	      count = 100,
	      ingredients = {
	        { "automation-science-pack", 1 },
	  ...
	  },
	  {
	    ...
	    prerequisites = {"small-spitter", "logistic-science-pack"},
	    unit = {
	      count = 100,
	      ingredients = {
	        { "automation-science-pack", 1 },
	  ...
	  },
	  {
	    ...
	    prerequisites = {"medium-spitter", "military-science-pack", "advanced-electronics", "engine"},
	    unit = {
	      count = 100,
	      ingredients = {
	        { "automation-science-pack", 1 },
	  ...
	  },
	  {
	    ...
	    prerequisites = {"big-spitter", "military-science-pack", "chemical-science-pack", "advanced-electronics-2", "robotics"},
	    unit = {
	      count = 100,
	      ingredients = {
	        { "automation-science-pack", 1 },
