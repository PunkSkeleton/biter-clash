...
function spawnNorthStart()
	...
	storage["northIronChest1"] = game.surfaces[storage["surfaceName"]].create_entity({name = "resource-chest", position = {x=-4, y=-745}, force =  "north"})
	storage["northIronChest2"] = game.surfaces[storage["surfaceName"]].create_entity({name = "resource-chest", position = {x=-2, y=-745}, force =  "north"})
	storage["northCopperChest"] = game.surfaces[storage["surfaceName"]].create_entity({name = "resource-chest", position = {x=-0, y=-745}, force =  "north"})
	storage["northStoneChest"] = game.surfaces[storage["surfaceName"]].create_entity({name = "resource-chest", position = {x=2, y=-745}, force =  "north"})
	storage["northCoalChest"] = game.surfaces[storage["surfaceName"]].create_entity({name = "resource-chest", position = {x=4, y=-755}, force =  "north"})
	game.surfaces[storage["surfaceName"]].create_entity({name = "free-water-pump", position = {x=2, y=-756}, force =  "north", direction = defines.direction.south})
...
function spawnSouthStart()
	...
	storage["southIronChest1"] = game.surfaces[storage["surfaceName"]].create_entity({name = "resource-chest", position = {x=-4, y=755}, force =  "south"})
	storage["southIronChest2"] = game.surfaces[storage["surfaceName"]].create_entity({name = "resource-chest", position = {x=-2, y=755}, force =  "south"})
	storage["southCopperChest"] = game.surfaces[storage["surfaceName"]].create_entity({name = "resource-chest", position = {x=-0, y=755}, force =  "south"})
	storage["southStoneChest"] = game.surfaces[storage["surfaceName"]].create_entity({name = "resource-chest", position = {x=2, y=755}, force =  "south"})
	storage["southCoalChest"] = game.surfaces[storage["surfaceName"]].create_entity({name = "resource-chest", position = {x=4, y=745}, force =  "south"})
	game.surfaces[storage["surfaceName"]].create_entity({name = "free-water-pump", position = {x=2, y=744}, force =  "south", direction = defines.direction.south})
